        ...
        <div class="container">
            ...
            <div class="col">
                <div class="card" style="width: 19rem;">
                    <img class="card-img-top" src="../../image/ao-dior.jpg">
                    <div class="card-body">
                        <p class="card-text brand">Dior</p>
                        <h5 class="card-title mb-1">Áo sơ mi nam</h5>
                        <p class="card-text giathanh">190.000<span>240000</span></p>
                        <p class="card-text tinhtrangsp">Còn hàng</p>
                        <a href="#" class="btn" id="chitietsanpham">Xem chi tiết</a>
                    </div>
                </div>
            </div>
            </div>
